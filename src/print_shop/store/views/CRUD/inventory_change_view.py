...
def inventory_change_list(request):
    ...
    return render(request, 'inventory_change/inventory_change_list.html', {'inventory_changes': inventory_changes})
...
def add_inventory_change(request):
    ...
    return render(request, 'inventory_change/inventory_change_form.html', {'form': form})
...
def delete_inventory_change(request, pk):
    ...
    if request.method == 'POST':
        ...
        return redirect('inventory-change-list')
    return render(request, 'inventory_change/inventory_change_confirm_delete.html', {'inventory_change': inventory_change})