...
class LoginPageTests(TestCase):
    ...
    def test_newsletter_subscription(self):
        ...
        response = self.client.post(
            reverse("newsletter_subscribe"), {"email": "newsletter@example.com"}
        )
    ...
    def test_invalid_email_format(self):
        ...
        self.assertFormError(
            response, "form", "username", "Enter a valid email address."
        )
...
class OrderTrackingPageTests(TestCase):
    ...
    def setUp(self):
        ...
        self.shipping = Shipping.objects.create(
            Name="Basic Shipping", Rate=5.99, ShipTime=5
        )
        ...
        self.inventory = InventoryChange.objects.create(
            RawMaterial=self.raw_material, QuantityWeightAvailable=950, UnitCost=0.02
        )
