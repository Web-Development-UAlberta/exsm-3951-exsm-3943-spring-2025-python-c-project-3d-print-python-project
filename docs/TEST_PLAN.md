...
| CF-CAT-05   | Products from each category load   | Clicking a category on the left loads all products from that category                             | High     |
| CF-CAT-06   | Product selection                  | Selecting a product adds it to the Product Selection section on the right                         | High     |
| CF-CAT-07   | Delete selection                   | Clicking delete removes the product from the selection                                            | High     |
| CF-CAT-08   | Cart checkout                      | Clicking the cart icon redirects to the checkout page                                             | High     |
